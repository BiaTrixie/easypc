...
const SignIn = () => {
  ...
  return (
    <div className=''>
      <h1 className='my-12 mb-20 bg-gradient-to-r from-purple-500 to-blue-600 bg-clip-text text-center font-raleway text-5xl font-extrabold text-transparent py-2'>
        ...
        <div className='h-full'>
          ...
          <div className='g-6 flex h-full flex-wrap items-center justify-center lg:justify-between'>
            <div className='shrink-1 mb-12 grow-0 basis-auto rounded-md bg-[#003f5c] md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12'>
              <img
                src='https://blog.leucotron.com.br/wp-content/uploads/2021/10/a-importancia-da-tecnologia-da-informacao-nas-empresas.jpeg'
                className='w-full '
                alt='Sample image'
              />
            </div>
