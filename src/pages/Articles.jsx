...
const Articles = () => {
  ...
  const fetchMoreBlogs = async () => {
    ...
    try {
      ...
      if (docSnap.empty) {
        setHasMore(false);
        toast.success("Todos os artigos encontrados!");
      }
      setLastBlog(lastVisible);
      const blogs = [];
      docSnap.forEach((doc) => {
      ...
      console.log(error);
      toast.error("Não foi possível buscar mais blogs!!");
    } finally {
  ...
  return (
    <div className='mx-auto max-w-7xl'>
      <h1 className=' my-12 text-center text-4xl font-extrabold'>Artigos</h1>
